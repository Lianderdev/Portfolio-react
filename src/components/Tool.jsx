export function Tool({ name, color, Img}) {
    return (
            <li style={{ userSelect: 'none' }} className="mt-4 flex flex-col items-center gap-3 font-normal pt-4 pb-3 rounded-lg text-[1.3rem] tracking-wider uppercase border-[1px] bg-tools 

...
export function Formation ({ img, alt, curso, nivel, instituicao, tempo }) {
    return (
        <div className='flex gap-6 p-6 border border rounded-xl relative'>
            <div className='mt-[5px] w-[4rem] h-[4rem] flex items-center justify-center border border-zinc-500 rounded-[50%] bg-zinc-50 p-1 object-cover'>

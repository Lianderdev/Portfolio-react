        ...
        <>
            <header className='bg-headerColor backdrop-blur-md py-8 flex justify-between items-center fixed top-0 left-1/2 transform -translate-x-1/2 z-20'>
                <div className='flex items-center gap-8'>
                    ...
                    <nav>
                        <ul className={`absolute top-0 h-[1000px] w-[300px] p-8 flex flex-col md:gap-4 z-30 duration-500 transition-all 
                        border-r border
                          ...
                          `}>
                            ...
                            <h3 className='md:hidden text-xl font-normal text-zinc-400 mt-16 mb-4'>Seções</h3>
                            ...
                            <div className='md:hidden flex flex-col gap-4'>
                                <h3 className='md:hidden text-xl font-normal mt-4 text-zinc-400'>Redes Socias</h3>
                                <ul>
            ...
            {/* Overlay */}
            <div className={` ${visible ? 'fixed' : 'hidden'} md:hidden top-0 left-0 w-full h-full bg-headerColor z-10 duration-500`}></div>
        </>
    )
}

    ...
    return (
        <>
            <header className='bg-headerColor backdrop-blur-md py-8 flex justify-between items-center fixed top-0 left-1/2 transform -translate-x-1/2 z-20'>
                        ...
                        `}>
                            ...
                            <div className='md:hidden flex flex-col gap-4'>
                                ...
                                <ul className='-mt-2'>
                                    ...
                                    <li className='link'>
                                        <a target='_blank' className='flex justify-between items-center' href="https://www.linkedin.com/in/liander-vin%C3%ADcius/">
                ...
                <div className={`${visible ? 'hidden' : 'flex'} flex items-center gap-6 transition-opacity duration-500`}>
